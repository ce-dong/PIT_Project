...
from src.builders.monthly_snapshot_base import MonthlySnapshotBaseBuilder
...
BUILDER_REGISTRY = {
    ...
    "monthly_snapshot_base": MonthlySnapshotBaseBuilder,
}

BUILD_ORDER = ["calendar_table", "adjusted_price_panel", "monthly_universe", "monthly_snapshot_base"]
